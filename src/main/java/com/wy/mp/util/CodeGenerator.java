...
//    }
    ...
    public static void main(String[] args) {
        ...
        autoGenerator.setDataSource(new DataSourceConfig()
                ...
                .setPassword("123456")
                // 数据库连接的url
                .setUrl("jdbc:mysql://localhost:3306/procurement_plan?useUnicode=true&characterEncoding=utf8&tinyInt1isBit=false&useSSL=false&useAffectedRows=true&serverTimezone=CTT")
        ...
        autoGenerator.setStrategy(new StrategyConfig()
                // 需要生成的表
                .setInclude("procurement_particulars")       //**********
                // 实体类使用Lombok
